...
const components = {
  ...
  h1: (props) => <h3 style={{ margin: '0.75em 0 0.5em', fontSize: '1.1em', fontWeight: 600 }} {...props} />,
  h2: (props) => <h4 style={{ margin: '0.5em 0 0.25em', fontSize: '1em', fontWeight: 600 }} {...props} />,
  h3: (props) => <h5 style={{ margin: '0.5em 0 0.25em', fontSize: '0.95em', fontWeight: 600 }} {...props} />,
  p: (props) => <p style={{ margin: '0.4em 0', lineHeight: 1.7 }} {...props} />,
  ul: (props) => <ul style={{ margin: '0.3em 0', paddingLeft: '1.5em' }} {...props} />,
  ...
  td: (props) => <td style={{ border: '1px solid var(--color-border, #ddd)', padding: '0.4em 0.75em' }} {...props} />,
};
