...
interface HighlightState {
  ...
  fetchHighlights: (paperId: number | string) => Promise<any>;
  createHighlight: (data: Record<string, any>) => Promise<any>;
  updateHighlight: (id: number | string, data: Record<string, any>) => Promise<any>;
